...
console.log(`${arr[2].Name}'s favorite singer is ${arr[2].favoriteSinger}`);

let sentence = `${myInformation1.name} watched ${myInformation1.mostRecentMovieWatched} the other day and liked it.`;

console.log(sentence);

console.log(
  `In our group we have ${arr[0].name}, ${arr[1].Name}, and ${arr[2].Name}. ${arr[1].Name} has a dog named ${arr[1].PetNames[0]} who loves to bark on car rides in ${arr[1].Name}'s ${arr[1].carsOwned[0].make} ${arr[1].carsOwned[0].model}`
);
